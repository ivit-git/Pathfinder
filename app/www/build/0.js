...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QuizCategoryPageModule", function() { return QuizCategoryPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__quiz_category__ = __webpack_require__(732);
...
QuizCategoryPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__quiz_category__["a" /* QuizCategoryPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__quiz_category__["a" /* QuizCategoryPage */]),
        ],
    })
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return QuizCategoryPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_sweetalert__ = __webpack_require__(733);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_jquery__ = __webpack_require__(714);
...
let QuizCategoryPage = class QuizCategoryPage {
    constructor(navCtrl, navParams, platform, loadingCtrl, _appService, eNumValue, databaseprovider, alertCtrl) {
        ...
        this.setLanguage = { Quiz: "", noDataFound: "", levelText: "", playQuiz: "", quizAlert: "", quizMessage: "" };
        this.allDisable = true;
        this.mascotImg = localStorage.getItem('mascotImg');
        ...
        this.databaseprovider.getDatabaseState().subscribe(rdy => {
            ...
            if (rdy) {
                ...
                this.databaseprovider.getQuizLevel(this.languageId).then(data => {
                    ...
                    console.log(data);
                    setTimeout(function () {
                        __WEBPACK_IMPORTED_MODULE_6_jquery__('#Id' + 1).css({ top: '78%', right: '10%', position: 'absolute' });
                        __WEBPACK_IMPORTED_MODULE_6_jquery__('#Id' + 2).css({ top: '38%', left: '15%', position: 'absolute' });
                    }, 100);
    ...
    showData() {
        if (this.levelId[1].Count == null || this.levelId[1].Count >= 0) {
            setTimeout(function () {
                __WEBPACK_IMPORTED_MODULE_6_jquery__('#Id' + 1).removeClass('disabled');
            }, 1000);
        }
        for (var i = 0; i < this.levelId.length; i++) {
            ...
            if (this.levelId[i].Count == 10) {
                const id2 = i + 1;
                setTimeout(function () {
                    __WEBPACK_IMPORTED_MODULE_6_jquery__('#Id' + id2).removeClass('disabled');
                }, 1000);
            }
        }
        if (this.levelId[1].Count == 10) {
            console.log('level 1');
            setTimeout(function () {
                __WEBPACK_IMPORTED_MODULE_6_jquery__('#Id' + 1).toggleClass('disabled');
            }, 1000);
        }
        if (this.levelId[0].Count == 10) {
            console.log('level 2');
            setTimeout(function () {
                __WEBPACK_IMPORTED_MODULE_6_jquery__('#Id' + 2).toggleClass('disabled');
            }, 1000);
        }
        this.quizSuccess();
    }
    ...
    validDate(questionLevel) {
        ...
        var d1 = new Date(this.startDateTime);
        ...
        if (this.startDateTime == null || difference >= 172800000) {
            ...
            __WEBPACK_IMPORTED_MODULE_5_sweetalert___default()('', this.setLanguage.quizMessage, 'error');
            return false;
        }
        // this.navCtrl.setRoot("QuizPage",{QuestionLevel:questionLevel});
...
QuizCategoryPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
        selector: 'page-quiz-category',template:/*ion-inline-start:"/home/nitish/Documents/pathfinder/src/pages/quiz-category/quiz-category.html"*/'<ion-header>\n  <ion-navbar>\n      <ion-row>\n          <ion-col col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 class="padding-horizontal">\n              <img class="left_img_header" src="assets/imgs/fb-icon-logo.png" float-left>\n              <!-- <ion-icon  name="md-arrow-round-back" (click)="gotoDashboard();"></ion-icon> -->\n          </ion-col>\n          <ion-col col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 class="vertical_align_middle">\n              <ion-title text-center>{{setLanguage.Quiz}}</ion-title>\n          </ion-col>\n          <ion-col col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 class="padding-horizontal">\n              <img class="right_img_header" src="assets/imgs/pathfinder-icon-logo.png" float-right>\n              <!-- <ion-title float-right class="font-size-14" (click)=changeLanguage(chooseLanguage)>{{chooseLanguage}}</ion-title> -->\n          </ion-col>\n      </ion-row>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content>\n<div class="quiz-back-img">\n    <div  class="final-position"> \n                <img class="flag-position" *ngIf="disableData != true"  src="assets/imgs/Flag_signal-grey.png" >\n                <img class="flag-position" *ngIf="disableData == true"  src="assets/imgs/Flag_signal-green.png" >\n                <img class="mascat-position" *ngIf="disableData == true" src="{{mascotImg}}">\n\n                <!-- <img *ngIf="levelId[0].Count > 7 && levelId[1].Count > 7" src="assets/imgs/Flag_signal-green.png" > -->\n    </div>\n\n        <div *ngFor="let level of levelId let i = index" [attr.data-index]="i" id="Id{{level.LevelId}}" class="quiz_{{level.LevelId}} disabled" (click)="gotoQuizContentPage(level.LevelId)" text-wrap>\n                <!-- {{setLanguage.Quiz}} {{level.LevelId}} -- {{levelId[i].Count}} -- {{i}}   -->\n                \n                <div *ngIf="level.LevelId == 1">\n                    <ion-col *ngIf="levelId[1].Count == null" col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 no-padding>\n                       <img src="assets/imgs/location-orange.png" >\n                       <button ion-button color="primary" float-right>{{setLanguage.Quiz}} {{level.LevelId}}</button>\n                    </ion-col>  \n                    <ion-col *ngIf="levelId[1].Count != null && levelId[1].Count < 10" col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 no-padding>\n                        <img src="assets/imgs/location-red.png" >\n                        <button ion-button color="primary" float-right> SCORE : {{levelId[1].Count}}/10 <br> TRY AGAIN</button>\n                     </ion-col>   \n                     <ion-col *ngIf="levelId[1].Count != null && levelId[1].Count == 10" col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 no-padding>\n                        <img src="assets/imgs/location-green.png" >\n                        <button ion-button color="primary" float-right> SCORE : {{levelId[1].Count}}/10 </button>\n                     </ion-col>   \n                </div>\n                <div *ngIf="level.LevelId == 2">\n                     <ion-col *ngIf="levelId[1].Count < 10 " col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 no-padding>\n                        <img src="assets/imgs/location-grey.png" >\n                        <button ion-button color="light" float-right>{{setLanguage.Quiz}} {{level.LevelId}}</button>\n                     </ion-col>  \n                     <ion-col *ngIf="levelId[1].Count == 10 && levelId[0].Count == null" col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 no-padding>\n                        <img src="assets/imgs/location-orange.png" >\n                        <button ion-button color="primary" float-right>{{setLanguage.Quiz}} {{level.LevelId}}</button>\n                     </ion-col> \n                     <ion-col *ngIf="levelId[0].Count != null && levelId[0].Count < 10 && levelId[1].Count != 0" col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 no-padding>\n                        <img src="assets/imgs/location-red.png" >\n                        <button ion-button color="primary" float-right>SCORE : {{levelId[0].Count}}/10 <br> TRY AGAIN</button>\n                     </ion-col>  \n                     <ion-col *ngIf="levelId[0].Count != null && levelId[0].Count == 10 && levelId[1].Count == 10" col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 no-padding>\n                        <img src="assets/imgs/location-green.png" >\n                        <button ion-button color="primary" float-right>SCORE : {{levelId[0].Count}}/10</button>\n                     </ion-col> \n                 </div>\n         </div>\n               \n  <!-- <ion-list>\n     \n        <ion-item *ngFor="let level of levelId let i = index" [attr.data-index]="i" id="Id{{level.LevelId}}" (click)="gotoQuizContentPage(level.LevelId)"  class= "disabled"  text-wrap>\n            {{setLanguage.levelText}} {{level.LevelId}} -- {{levelId[i].Count}} -- {{i}}\n          \n             <ion-icon name="ios-arrow-forward" item-end></ion-icon>\n         </ion-item>\n       \n</ion-list> -->\n</div>\n\n</ion-content>\n<ion-footer>\n  <ion-grid class="footer_Grid">\n      <ion-row>\n          <ion-col col-6>\n              <img src="assets/imgs/back.png" height="35px" (click)="gotoDashboard();">\n              <!-- <ion-icon  class="footer-Icon" name="md-arrow-back" (click)="gotoDashboard();"></ion-icon> -->\n          </ion-col>\n          <ion-col col-6>\n                <ion-icon class="refershIcon" name="refresh" style="zoom:2.3;" color="light" (click)="playAgain();" float-right></ion-icon>\n                <!-- <ion-icon  class="footer-Icon" name="md-arrow-back" (click)="gotoDashboard();"></ion-icon> -->\n            </ion-col>\n      </ion-row>\n  </ion-grid>\n</ion-footer>'/*ion-inline-end:"/home/nitish/Documents/pathfinder/src/pages/quiz-category/quiz-category.html"*/,
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* LoadingController */],
        __WEBPACK_IMPORTED_MODULE_3__providers_app_service__["a" /* AppServices */], __WEBPACK_IMPORTED_MODULE_2__providers_app_enum__["a" /* AppEnum */], __WEBPACK_IMPORTED_MODULE_4__providers_database_service__["a" /* DatabaseProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
], QuizCategoryPage);

//# sourceMappingURL=quiz-category.js.map
