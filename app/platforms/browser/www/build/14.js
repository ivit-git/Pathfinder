...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__faq__ = __webpack_require__(731);
...
FaqPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__faq__["a" /* FaqPage */]),
        ],
    })
], FaqPageModule);
...
let FaqPage = class FaqPage {
    ...
    gotoFAQAnswer(getFAQ, index) {
        ...
        __WEBPACK_IMPORTED_MODULE_5_jquery__(".faqContent").addClass("display-none");
        __WEBPACK_IMPORTED_MODULE_5_jquery__(".ansContent_" + index).removeClass("display-none");
        __WEBPACK_IMPORTED_MODULE_5_jquery__(".downSign").removeClass("display-none");
        __WEBPACK_IMPORTED_MODULE_5_jquery__(".downSign_" + index).addClass("display-none");
        __WEBPACK_IMPORTED_MODULE_5_jquery__(".faqAnswer").html(getFAQ.Answer);
    }
    gotoFAQMethods() {
