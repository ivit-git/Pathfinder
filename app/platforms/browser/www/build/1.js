...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_profile__ = __webpack_require__(729);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_app_enum__ = __webpack_require__(352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_app_service__ = __webpack_require__(715);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_jquery__ = __webpack_require__(714);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_device__ = __webpack_require__(356);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let UserProfilePage = class UserProfilePage {
    constructor(navCtrl, navParams, fb, device, platform, eNumValue, _appService, loadingCtrl) {
        ...
        this.masterData = { "Languages": "", "StackHolders": "", "Gender": "", "Organization": "", "Country": "", "States": [] };
        this.setLanguage = { "interNetMsg": "", "User_Profile": "", "User_Name": "", "User_Type": "", "Gender": "", "Date_of_Birth": "", "Orgnization_Type": "", "Preferd_Language": "", "Country": "", "State": "", "District": "", "Mobile_No": "", "Save": "", "Cancel": "" };
        ...
        this.userProfile = fb.group({
            ...
            userType: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required])],
            ...
            dateOfBirth: [''],
            oragType: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required])],
            preferdLanguage: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required])],
            ...
            district: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required])],
            mobile: ['']
        });
    }
    ionViewDidLoad() {
        ...
        __WEBPACK_IMPORTED_MODULE_5_jquery__(document).ready(function () {
            ...
            __WEBPACK_IMPORTED_MODULE_5_jquery__("[type='date']").prop('max', maxDate);
            __WEBPACK_IMPORTED_MODULE_5_jquery__(".dob_Calender_icon").click(function () {
                __WEBPACK_IMPORTED_MODULE_5_jquery__(".dob_Calender").click();
            });
        });
    ...
    chkCountry(value) {
        ...
        if (value == "2") {
            __WEBPACK_IMPORTED_MODULE_5_jquery__('.countrychk').addClass("display_none");
            ...
            __WEBPACK_IMPORTED_MODULE_5_jquery__('.countrychk').removeClass("display_none");
            this.userProfile.get('state').setValidators([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]);
            this.userProfile.get('district').setValidators([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]);
            this.userProfile.get('state').updateValueAndValidity();
            this.userProfile.get('district').updateValueAndValidity();
        }
    }
