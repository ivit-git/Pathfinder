...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IncentivesPageModule", function() { return IncentivesPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__incentives__ = __webpack_require__(719);
...
let IncentivesPageModule = class IncentivesPageModule {
};
IncentivesPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__incentives__["a" /* IncentivesPage */]
        ],
        imports: [
            // PdfViewerModule,
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__incentives__["a" /* IncentivesPage */]),
        ],
    })
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return IncentivesPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ionic_img_viewer__ = __webpack_require__(357);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let IncentivesPage = class IncentivesPage {
    constructor(navCtrl, navParams, platform, loadingCtrl, _appService, eNumValue, databaseprovider, imageViewerCtrl) {
        ...
        this.setLanguage = { incentive: "", incentiveLabel: "", indeminityLabel: "" };
        this.methods = "incentive";
...
IncentivesPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
        selector: 'page-incentives',template:/*ion-inline-start:"/home/nitish/Documents/pathfinder/src/pages/incentives/incentives.html"*/'<ion-header>\n    <ion-navbar>\n        <ion-row>\n            <ion-col col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 class="padding-horizontal">\n                <img class="left_img_header" src="assets/imgs/fb-icon-logo.png" float-left>\n                <!-- <ion-icon  name="md-arrow-round-back" (click)="gotoDashboard();"></ion-icon> -->\n            </ion-col>\n            <ion-col col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 class="vertical_align_middle">\n                <ion-title text-center>{{setLanguage.incentive}}</ion-title>\n            </ion-col>\n            <ion-col col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 class="padding-horizontal">\n                <img class="right_img_header" src="assets/imgs/pathfinder-icon-logo.png" float-right>\n                <!-- <ion-title float-right class="font-size-14" (click)=changeLanguage(chooseLanguage)>{{chooseLanguage}}</ion-title> -->\n            </ion-col>\n        </ion-row>\n    </ion-navbar>\n</ion-header>\n\n\n<ion-content>\n    <div padding>\n             <ion-segment [(ngModel)]="methods">\n                 <ion-segment-button value="incentive" >\n                    {{setLanguage.incentiveLabel}}\n                 </ion-segment-button>\n                 <ion-segment-button value="indemnity">\n                    {{setLanguage.indeminityLabel}}\n                 </ion-segment-button>\n            </ion-segment>\n    </div>\n    <div [ngSwitch]="methods">\n            <div padding *ngSwitchCase="\'incentive\'">\n                    <img *ngIf="chooseLanguage==eNumValue.Entitylanguage.language_hindi" src="assets/imgs/Incentives_04.jpg" #myImage (click)="presentImage(myImage)" text-center/>\n                    <img *ngIf="chooseLanguage==eNumValue.Entitylanguage.language_english" src="assets/imgs/Incentives hindi final_02.jpg" #myImage (click)="presentImage(myImage)" text-center/>\n            </div>\n    \n            <div padding *ngSwitchCase="\'indemnity\'">\n                    <img *ngIf="chooseLanguage==eNumValue.Entitylanguage.language_hindi" src="assets/imgs/Indemnity Scheme_04In.jpg" #myImage (click)="presentImage(myImage)" text-center/>\n                    <img *ngIf="chooseLanguage==eNumValue.Entitylanguage.language_english" src="assets/imgs/Indemnity Scheme_Hindi_02.jpg" #myImage (click)="presentImage(myImage)" text-center/>\n            </div>\n    </div>\n    <!-- <img *ngIf="chooseLanguage==eNumValue.Entitylanguage.language_hindi" src="assets/imgs/Incentives.jpg" #myImage (click)="presentImage(myImage)" text-center/>\n    <img *ngIf="chooseLanguage==eNumValue.Entitylanguage.language_english" src="assets/imgs/Incentives_hindi.jpg" #myImage (click)="presentImage(myImage)" text-center/> -->\n</ion-content>\n<ion-footer>\n    <ion-grid class="footer_Grid">\n        <ion-row>\n            <ion-col col-6>\n                <img src="assets/imgs/back.png" height="35px" (click)="gotoDashboard();">\n            </ion-col>\n            <ion-col col-6>\n                <!-- <div float-right (click)=changeLanguage(chooseLanguage)><img class="footer_language_icon" [src]="languageIcon"></div> -->\n            </ion-col>\n        </ion-row>\n    </ion-grid>\n</ion-footer>'/*ion-inline-end:"/home/nitish/Documents/pathfinder/src/pages/incentives/incentives.html"*/,
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* LoadingController */],
        __WEBPACK_IMPORTED_MODULE_3__providers_app_service__["a" /* AppServices */], __WEBPACK_IMPORTED_MODULE_2__providers_app_enum__["a" /* AppEnum */], __WEBPACK_IMPORTED_MODULE_4__providers_database_service__["a" /* DatabaseProvider */], __WEBPACK_IMPORTED_MODULE_5_ionic_img_viewer__["a" /* ImageViewerController */]])
], IncentivesPage);
