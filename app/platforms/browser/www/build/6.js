...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__quiz__ = __webpack_require__(732);
...
QuizPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__quiz__["a" /* QuizPage */]),
        ],
    })
], QuizPageModule);
...
let QuizPage = class QuizPage {
    constructor(navCtrl, navParams, platform, loadingCtrl, _appService, eNumValue, databaseprovider) {
        ...
        this.correctCount = 0;
        this.setLanguage = { Quiz: "", correct: "", incorrect: "", response: "" };
        this.questionModal = [];
        this.QuestionLevel = this.navParams.get('QuestionLevel');
        this.shuffleArray = [];
    ...
    validateAnswer(QuestionNo, answer, index) {
      ...
      <div class="preloader">
        ...
        __WEBPACK_IMPORTED_MODULE_5_jquery__('.rightAns_' + QuestionNo).css("display", "none");
        __WEBPACK_IMPORTED_MODULE_5_jquery__('.wrongAns_' + QuestionNo).css("display", "none");
        if (answer == "1") {
            __WEBPACK_IMPORTED_MODULE_5_jquery__('.rightAns_' + QuestionNo).css("display", "block");
            this.correctCount++;
            ...
            this.databaseprovider.getDatabaseState().subscribe(rdy => {
                if (rdy) {
                    ...
                    this.databaseprovider.getAnswerByQuestion(this.QuestionLevel, QuestionNo, this.languageId).then(data => {
                        ...
                        __WEBPACK_IMPORTED_MODULE_5_jquery__('.wrongAns_' + QuestionNo).css("display", "block");
                        __WEBPACK_IMPORTED_MODULE_5_jquery__('.correctAns_' + QuestionNo).text(data[0].QuestionOptions);
                    }, err => {
                        this.loadingPopup.dismiss();
                    });
                }
