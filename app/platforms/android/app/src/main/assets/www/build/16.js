...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dashboard__ = __webpack_require__(734);
...
let AppServices = class AppServices {
    ...
    deleteData(url) {
        return this.http.delete(url, this.options)
            ...
            return __WEBPACK_IMPORTED_MODULE_4_rxjs_Rx__["Observable"].throw(new Error(error.status));
        });
    }
    getData_new(url) {
    ...
    onimgclick(e) {
        var Selected_url = __WEBPACK_IMPORTED_MODULE_5_jquery__(e.target).attr('src');
...
AppServices = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */], __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["q" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_photo_viewer__["a" /* PhotoViewer */]])
], AppServices);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_zip__ = __webpack_require__(361);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_jquery__ = __webpack_require__(715);
...
let DashboardPage = class DashboardPage {
    constructor(navCtrl, navParams, _appService, transfer, file, platform, eNumValue, loadingCtrl, alertCtrl, databaseprovider, zip) {
        ...
        this.zip = zip;
        this.loadProgress = 0;
        this.setLanguage = { "downloadMsg": "", "updateMsg": "", "interNetMsg": "", "noUpdate": "", "overview": "", "Faq": "", "keyMessage": "", "counselling": "", "Quiz": "", "library": "", "incentive": "", "AskUs": "", "Methods": "" };
    ...
    ionViewDidLoad() {
        ...
        if (this.userDetail.StackholderId == '1') {
            __WEBPACK_IMPORTED_MODULE_8_jquery__('.dashboard-back-img').css('background-image', "url('assets/imgs/FP-Mascot-DOCTOR.png')");
            localStorage.setItem('mascotImg', 'assets/imgs/FP-Mascot-DOCTOR.png');
        }
        else if (this.userDetail.StackholderId == '2') {
            __WEBPACK_IMPORTED_MODULE_8_jquery__('.dashboard-back-img').css('background-image', "url('assets/imgs/FP-Mascot-NURSE.png')");
            localStorage.setItem('mascotImg', 'assets/imgs/FP-Mascot-NURSE.png');
        }
        else if (this.userDetail.StackholderId == '5') {
            __WEBPACK_IMPORTED_MODULE_8_jquery__('.dashboard-back-img').css('background-image', "url('assets/imgs/FP-Mascot-MIDWIFE-0003.png')");
    ...
    makeLocalData(methodList) {
        ...
        for (var i = 0; i < methodList.length; i++) {
            ...
            tempJson = {
                ...
                "MobileIconURL": Object(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["x" /* normalizeURL */])(ImageIconURL),
    ...
    unzipfile(zipPath) {
        ...
        this.loadProgress = Math.round((progress.loaded / progress.total) * 100))
            ...
            if (result === 0) {
                ...
                __WEBPACK_IMPORTED_MODULE_8_jquery__('.refershIcon').addClass('display_none');
    ...
    deleteAllData() {
        var ths = this;
        this.file.removeFile(this.DownloadDirectory, 'liveData.zip').then(_ => ths.file.removeRecursively(ths.DownloadDirectory, 'Content_Images').then(_ => ths.getLatestContent()).catch(err => console.log('Directory doesn\'t delete'))).catch(err => console.log('Directory doesn\'t delete'));
    }
    getLatestContent() {
        this.loadingPopup = this.loadingCtrl.create({
            spinner: 'hide',
    ...
    openModel() {
        __WEBPACK_IMPORTED_MODULE_8_jquery__('#myModal').css("display", "block");
    }
    closeModel() {
        __WEBPACK_IMPORTED_MODULE_8_jquery__('#myModal').css("display", "none");
    }
};
DashboardPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
        selector: 'page-dashboard',template:/*ion-inline-start:"/home/nitish/Documents/pathfinder/src/pages/dashboard/dashboard.html"*/'<!-- <ion-header>\n    <ion-navbar>\n        <ion-row>\n            <ion-col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 no-padding>\n                <img class="header-logo-img" src="assets/imgs/full-logo.png">\n            </ion-col>\n        </ion-row>\n    </ion-navbar>\n</ion-header> -->\n\n\n\n<ion-content padding class="bgContentColor" scrollY="true">\n    <div class="progress"></div>\n\n    <div class="container p-0">\n\n      <div class="d-flex">\n          <div class="flex-fill">\n              <img class="mx-auto d-block pathfinder_logo" src="assets/img/img2.png" alt="Pathfinder">\n          </div>\n      </div>\n      <div class="bg-div">\n          <div class="row m-0">\n              <div class="col-4 d-flex text-light text-center font-weight-bold button-div">\n                  <a href="" class="button-sec flex-fill">\n                      <img class="mx-auto d-block button_logo" src="assets/img/fb overviewt.png" alt="FP OVERVIEW">\n                      <span class="button_text">FP OVERVIEW</span>\n                  </a>\n              </div>\n              <div class="col-4 d-flex text-light text-center font-weight-bold button-div">\n                  <a (click)="startDateTime(\'ContraceptiveMethods\');" class="button-sec flex-fill">\n                      <img class="mx-auto d-block button_logo" src="assets/img/Contarceptive Methodt.png" alt="CONTRACEPTIVE METHOD">\n                      <span class="button_text">CONTRACEPTIVE METHODS</span>\n                  </a>\n              </div>\n              <div class="col-4 d-flex text-light text-center font-weight-bold button-div">\n                  <a href="" class="button-sec flex-fill">\n                      <img class="mx-auto d-block button_logo" src="assets/img/counceling.png" alt="COUNSELING">\n                      <span class="button_text">COUNSELING</span>\n                  </a>\n              </div>\n          </div>\n          <div class="row m-0">\n              <div class="col-3 d-flex flex-column text-light text-center font-weight-bold button-div">\n                  <a (click)="gotoTopicsListPageTest(\'keymessages\',\'KEY MESSAGE\')" class="button-sec button-col h-100 d-flex justify-content-center flex-column">\n                      <img class="mx-auto d-block button_logo" src="assets/img/key massage.png" alt="KEY MESSAGE">\n                      <span class="button_text">KEY MESSAGE</span>\n                  </a>\n                  <a href="" class="button-sec button-col h-100 d-flex justify-content-center flex-column">\n                      <img class="mx-auto d-block button_logo" src="assets/img/ask us.png" alt="ASK US">\n                      <span class="button_text">ASK US</span>\n                  </a>\n                  <a href="" class="button-sec button-col h-100 d-flex justify-content-center flex-column">\n                      <img class="mx-auto d-block button_logo" src="assets/img/library.png" alt="LIBRARY">\n                      <span class="button_text">LIBRARY</span>\n                  </a>\n              </div>\n              <div class="col-6 button-div px-1 pt-1 pb-0">\n                  <div class="col-12 d-flex flex-column text-light text-center font-weight-bold bg-mid-img">\n                      <a href="" class="button-sec flex-fill mid-img">\n                      </a>\n                  </div>\n              </div>\n              <div class="col-3 d-flex flex-column text-light text-center font-weight-bold button-div">\n                  <a href="" class="button-sec button-col h-100 d-flex justify-content-center flex-column">\n                      <img class="mx-auto d-block button_logo" src="assets/img/faq.png" alt="FAQ">\n                      <span class="button_text">FAQ</span>\n                  </a>\n                  <a href="" class="button-sec button-col h-100 d-flex justify-content-center flex-column">\n                      <img class="mx-auto d-block button_logo" src="assets/img/quiz.png" alt="QUIZ">\n                      <span class="button_text">QUIZ</span>\n                  </a>\n                  <a href="" class="button-sec button-col h-100 d-flex justify-content-center flex-column">\n                      <img class="mx-auto d-block button_logo" src="assets/img/yfs.png" alt="YFS">\n                      <span class="button_text">YFS</span>\n                  </a>\n              </div>\n          </div>\n\n      </div>\n      <div class="d-flex justify-content-center">\n          <div class="p-2">\n              <b class="text-footer">WITH SUPPORT FROM</b>\n          </div>\n      </div>\n      <div class="d-flex justify-content-center bg-footer">\n          <div class="p-2 " (click)="gotoDashboard();">\n              <img class="mx-auto d-block footer_logo" src="assets/img/img5.png" alt="LOGO">\n          </div>\n          <div class="p-2 " (click)="gotoDashboard();">\n              <img class="mx-auto d-block footer_logo" src="assets/img/img4.jpg" alt="LOGO">\n          </div>\n          <div class="p-2 " (click)="gotoDashboard();">\n              <img class="mx-auto d-block footer_logo" src="assets/img/img6.png" alt="LOGO">\n          </div>\n      </div>\n  </div>\n\n</ion-content>\n'/*ion-inline-end:"/home/nitish/Documents/pathfinder/src/pages/dashboard/dashboard.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_3__providers_app_service__["a" /* AppServices */], __WEBPACK_IMPORTED_MODULE_2__providers_app_enum__["a" /* AppEnum */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_file_transfer__["a" /* FileTransfer */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_file_transfer__["b" /* FileTransferObject */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_file__["a" /* File */]]
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__providers_app_service__["a" /* AppServices */],
        __WEBPACK_IMPORTED_MODULE_5__ionic_native_file_transfer__["a" /* FileTransfer */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_file__["a" /* File */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* Platform */],
        __WEBPACK_IMPORTED_MODULE_2__providers_app_enum__["a" /* AppEnum */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
        __WEBPACK_IMPORTED_MODULE_4__providers_database_service__["a" /* DatabaseProvider */], __WEBPACK_IMPORTED_MODULE_7__ionic_native_zip__["a" /* Zip */]])
], DashboardPage);
