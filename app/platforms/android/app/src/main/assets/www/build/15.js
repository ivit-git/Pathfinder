...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FaqMethodsPageModule", function() { return FaqMethodsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__faq_methods__ = __webpack_require__(718);
...
let FaqMethodsPageModule = class FaqMethodsPageModule {
};
FaqMethodsPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__faq_methods__["a" /* FaqMethodsPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__faq_methods__["a" /* FaqMethodsPage */]),
        ],
    })
], FaqMethodsPageModule);

//# sourceMappingURL=faq-methods.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FaqMethodsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
...
let FaqMethodsPage = class FaqMethodsPage {
    constructor(navCtrl, navParams, platform, loadingCtrl, _appService, eNumValue, databaseprovider, tts) {
        ...
        this.tts = tts;
        this.setLanguage = { Faq: "", noDataFound: "" };
...
FaqMethodsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
        selector: 'page-faq-methods',template:/*ion-inline-start:"/home/nitish/Documents/pathfinder/src/pages/faq-methods/faq-methods.html"*/'<ion-header>\n  <ion-navbar>\n      <ion-row>\n          <ion-col col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 class="padding-horizontal">\n              <img class="left_img_header" src="assets/imgs/fb-icon-logo.png" float-left>\n              <!-- <ion-icon  name="md-arrow-round-back" (click)="gotoDashboard();"></ion-icon> -->\n          </ion-col>\n          <ion-col col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 class="vertical_align_middle">\n              <ion-title text-center>{{setLanguage.Faq}}</ion-title>\n          </ion-col>\n          <ion-col col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 class="padding-horizontal">\n              <img class="right_img_header" src="assets/imgs/pathfinder-icon-logo.png" float-right>\n              <!-- <ion-title float-right class="font-size-14" (click)=changeLanguage(chooseLanguage)>{{chooseLanguage}}</ion-title> -->\n          </ion-col>\n      </ion-row>\n  </ion-navbar>\n</ion-header>\n\n\n\n<ion-content>\n  <!-- <ion-grid>\n      <ion-list>\n          <ion-item *ngFor="let getMethods of allMethods" (click)="gotoFAQPage(getMethods)" text-wrap>\n              <ion-avatar item-start class="circle">\n                  <img src="{{getMethods.TabletIconURL}}">\n              </ion-avatar>\n              {{getMethods.MethodName}}\n              <ion-icon name="ios-arrow-forward" item-end></ion-icon><br>\n          </ion-item>\n      </ion-list>\n  </ion-grid> -->\n\n  <!-- <ion-grid class="width-100" *ngIf="languageId==\'1\'">\n       \n      <ion-row class="border-bottom">\n           \n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/IUCD-Icon.png" (click)="gotoFAQPage(\'1\');">\n          </ion-col>\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/dmpa-icon.png" (click)="gotoFAQPage(\'2\');">\n          </ion-col>\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/coc-icon.png" (click)="gotoFAQPage(\'3\');">\n          </ion-col>\n\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/ecp-icon.png" (click)="gotoFAQPage(\'4\');">\n          </ion-col>\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/centchroman-icon.png" (click)="gotoFAQPage(\'5\');">\n          </ion-col>\n\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/condom-icon.png" (click)="gotoFAQPage(\'8\');">\n          </ion-col>\n      </ion-row>\n      <ion-row text-center>\n        <hr/>\n       \n    </ion-row>\n      <ion-row>\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/male-stre.png" (click)="gotoFAQPage(\'6\');">\n          </ion-col>\n\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/female-stre.png" (click)="gotoFAQPage(\'7\');">\n          </ion-col>\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="{{mascotImg}}" style="margin-top: -15px;">\n          </ion-col>\n      </ion-row>\n     \n  </ion-grid> -->\n\n  <!-- <ion-grid class="width-100" *ngIf="languageId==\'2\'">\n     \n      <ion-row class="border-bottom">\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/iucd-hindi-icon.png" (click)="gotoFAQPage(\'9\');">\n          </ion-col>\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src=" assets/methods/dmpa-hindi-icon.png" (click)="gotoFAQPage(\'10\');">\n          </ion-col>\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/coc-hindi-icon.png" (click)="gotoFAQPage(\'11\');">\n          </ion-col>\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/ECP-hindi-icon.png" (click)="gotoFAQPage(\'12\');">\n          </ion-col>\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/centchroman-hindi-icon.png" (click)="gotoFAQPage(\'13\');">\n          </ion-col>\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/condom-hindi-icon.png" (click)="gotoFAQPage(\'16\');">\n          </ion-col>\n\n      </ion-row>\n      <ion-row text-center>\n        <hr/>\n        \n    </ion-row>\n      <ion-row>\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/male-sterilization-hindi-icon.png " (click)="gotoFAQPage(\'14\');">\n          </ion-col>\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4>\n              <img src="assets/methods/female-sterilization-hindi-icon.png" (click)="gotoFAQPage(\'15\');">\n          </ion-col>\n          <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 style="margin-top: -15px;">\n              <img src="{{mascotImg}}">\n          </ion-col>\n      </ion-row>\n\n  </ion-grid> -->\n  <ion-grid class="width-100" >\n    <ion-row text-center>\n        <ion-col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center no-padding>\n            <h4 class="purple" no-margin margin-top> SPACING</h4>\n        </ion-col>\n    </ion-row>\n    <ion-row class="border-bottom"   text-wrap>\n      \n        <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 *ngFor="let getMethods of spacingMethod" (click)="gotoFAQPage(getMethods.MethodId)">\n            <img src="{{getMethods.MobileIconURL}}" >\n        </ion-col>\n    </ion-row>\n</ion-grid>\n\n<ion-grid class="width-100"  >\n    <ion-row text-center>\n        <ion-col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center no-padding>\n            <h4 class="purple" no-margin margin-top> LIMITING</h4>\n        </ion-col>\n    </ion-row>\n    <ion-row class="border-bottom"  text-wrap>\n      \n        <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4  *ngFor="let getMethods of limitingMethod" (click)="gotoFAQPage(getMethods.MethodId)">\n            <img src="{{getMethods.MobileIconURL}}" >\n        </ion-col>\n        <ion-col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 style="margin-top: -15px;">\n            <img src="{{mascotImg}}">\n        </ion-col>\n    </ion-row>\n</ion-grid>\n</ion-content>\n<ion-footer>\n  <ion-grid class="footer_Grid">\n      <ion-row>\n          <ion-col col-6>\n              <img src="assets/imgs/back.png" height="35px" (click)="gotoDashboard();">\n           </ion-col>\n          <ion-col col-6>\n              <!-- <div float-right (click)=changeLanguage(chooseLanguage)><img class="footer_language_icon" [src]="languageIcon"></div> -->\n          </ion-col>\n      </ion-row>\n  </ion-grid>\n</ion-footer>'/*ion-inline-end:"/home/nitish/Documents/pathfinder/src/pages/faq-methods/faq-methods.html"*/,
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* LoadingController */],
        __WEBPACK_IMPORTED_MODULE_3__providers_app_service__["a" /* AppServices */], __WEBPACK_IMPORTED_MODULE_2__providers_app_enum__["a" /* AppEnum */], __WEBPACK_IMPORTED_MODULE_4__providers_database_service__["a" /* DatabaseProvider */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_text_to_speech__["a" /* TextToSpeech */]])
], FaqMethodsPage);

//# sourceMappingURL=faq-methods.js.map
